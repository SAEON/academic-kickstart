...
dat <- dat[which(dat$Site == "Jonkershoek" & dat$Owner =="SAEON"),]

name = paste0(dat$`Station name`, " <br/> ", "(", dat$Variables, ")")
  
dat <- data.frame(lat = dat$Latitude, lon = dat$Longitude)
